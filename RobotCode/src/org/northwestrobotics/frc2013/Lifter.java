...
/**
 * Manages the state for the lifting subsystem, and activates the climber on user command.
 * @author soggy.potato
 * @author AgentOrange
 */
public final class Lifter {
    ...
    /**
     * The solenoids used for to allow the robot to perform the movement necessary for climbing.
     * @author AgentOrange
     * @author RG3
     */
    ...
    /**
     * Initializes the lifter. Specifically, gives the lifter access to the joystick used for user input.
     * @param moveController The joystick used to activate the climbing function.
     */
