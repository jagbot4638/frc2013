 ...
 * to generic sensors that could receive events. It additionally stores the
 * state of variables, and automatically performs state change checks.
 *
 * @author soggy.potato
 */
public abstract class PollingSensor extends Sensor {
    ...
    /**
     *
     * Construct a polling sensor. * Subclasses need to start themselves-- make
     * a call to start();
     *
